...
-- ===============================
-- Solo profesionales que trabajaron en AMBOS SECTORES
-- ===============================
WHERE 
    p.id_profesional IN (
...
PROMPT ==========================================================
PROMPT CASO 1 EJECUTADO CORRECTAMENTE
PROMPT ==========================================================
...
SELECT 
    ...
    -- Honorario mínimo y máximo del mes
...
WHERE 
    -- Asesorías de ABRIL del año pasado
